...
public interface Constants {
	public static final String API_KEY = "5ab920eb33dc959f74628e47e37f41b6";
//	public static final String METHOD = "flickr.interestingness.getList";
	public static final String METHOD = "flickr.photos.search";
	public static final String EXTRAS = "&extras=tags";
	public static final String TAGS = "&tags=tiger";
